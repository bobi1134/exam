...
<html>
	...
	<div class="page-container">
		<a href="${ctx}/admin/photoConfigAnalysis/successRate/${photoConfigId}/${student.id}" class="btn btn-primary radius r">返回</a>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			gridObj = $.fn.bsgrid.init('bsGrid', {
				url: '/admin/photoConfigAnalysis/successRateDetails/${photoConfigId}/${student.id}',
				pageSizeSelect: true,
				pageSize: 20
			});
		});
